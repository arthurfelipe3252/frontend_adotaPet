                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        widget.isEditing ? 'Editar pet' : 'Cadastrar novo pet',
          ...
          children: [
            _Section(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Mínimo 1 foto. JPG, PNG, WEBP · máx. 5MB',
                  ...
                  _Field(
                    ...
                    child: _Select(
                      ...
                      items: const [
                        DropdownMenuItem(
                          value: 'pequeno',
                          child: Text('Pequeno (<10kg)'),
                        ),
                        DropdownMenuItem(
                          value: 'medio',
                          child: Text('Médio (10-25kg)'),
                        ),
                        DropdownMenuItem(
                          value: 'grande',
                          child: Text('Grande (>25kg)'),
                        ),
                      ],
            ...
            _Section(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Selecione até 6 características',
                  ...
                  _Field(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        filled: true,
                        fillColor: const Color(0xFFEEEAE6),
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          ...
          borderSide: hasError
              ? const BorderSide(color: Colors.red, width: 1.5)
              : const BorderSide(color: Color(0xFFCC6633), width: 1.5),
        ),
      ...
      child: Row(
        ...
        children: [
          ...
          Switch(
            value: value,
            onChanged: onChanged,
            activeThumbColor: const Color(0xFFCC6633),
          ),
        ],
      ),
    );
